    ...
    def do_GET(self):
        ...
        if first_argument == "/":
            ...
            try:
                ...
                elif int(third_argument) > len(species) or int(third_argument) < 0:
                        ...
                        if element["coord_system"] == "chromosome":
                            if element["name"] == chromosome:
                                contents = f"""
                                            ...
                                            """
                                contents += f"""<p> The length of the chromosome {chromosome} of the {species} is: 
                                             {element["length"]} </p> """
                    error_code = 200
            ...
            try:
                ...
                # If everything is correct
                    ...
                    for base in bases:
                        ...
                        contents += f"""<p> The number of {base} in the gene is {seq.count_base(base)} which is a 
                                    {base_percentage} %"""
                    error_code = 200
            ...
            try:
                ...
                PARAM = "?feature=gene;content-type=application/json"
                ...
                # If everything is correct
                    ...
                    contents = f"""
                                ...
                                """
                    contents += f"""<b>The list of genes of chromosome {chromo} between the positions {start} and {end} 
                                is: </b>"""
                    for element in sequence:
                        contents += f"""<p>{element["external_name"]}"""
